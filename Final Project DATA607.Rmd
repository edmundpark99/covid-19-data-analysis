...
![A boxplot showcasing the distribution of confirmed cases by the top regions via administrative area.](Distribution of Confirmed Cases by Region.png)
...
![A Time Series graph showcasing the number of COVID-19 Cases over Time by Region](COVID-19 Case Trends Over Time by Region.png)
...
![A Scatterplot showcasing the Stringency Index compared to the number of cases](Stringency Index.png)
...
![The Regression Model Residual Analysis](Residuals of the Regression Model.png)
...
![Plot of Residuals](Residual Plot.png)
